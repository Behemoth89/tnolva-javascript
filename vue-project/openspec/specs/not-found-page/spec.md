...
### Requirement: Not Found Page Displays for Invalid Routes

The application SHALL display a 404 page for routes that don't exist.

#### Scenario: Invalid route access

- **WHEN** user navigates to an invalid route
- **THEN** 404 page SHALL be displayed

### Requirement: Not Found Page Shows Navigation Options

The 404 page SHALL provide navigation options to help users.

#### Scenario: Navigation options available

- **WHEN** 404 page renders
- **THEN** "Go Home" button SHALL be visible
- **AND** "Sign In" button SHALL be visible
