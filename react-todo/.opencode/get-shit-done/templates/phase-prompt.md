...
<!-- For checkpoint task examples and patterns, see @C:/Kool/tnolva-javascript/react-todo/.opencode/get-shit-done/references/checkpoints.md -->
...
See `C:/Kool/tnolva-javascript/react-todo/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Kool/tnolva-javascript/react-todo/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Kool/tnolva-javascript/react-todo/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
