...
- **Global scope**: `C:/Kool/tnolva-javascript/react-todo/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Kool/tnolva-javascript/react-todo/.opencode/notes/`)
...
2. Glob `C:/Kool/tnolva-javascript/react-todo/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Kool/tnolva-javascript/react-todo/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Kool/tnolva-javascript/react-todo/.opencode/notes/` — works in any directory
