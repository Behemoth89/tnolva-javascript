...
```markdown
Read C:/Kool/tnolva-javascript/nutikas/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Kool/tnolva-javascript/nutikas/.opencode/agents/gsd-ui-checker.md for instructions.
