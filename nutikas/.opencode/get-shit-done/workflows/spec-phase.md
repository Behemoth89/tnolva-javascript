...
```bash
INIT=$(node "C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/spec.md.
