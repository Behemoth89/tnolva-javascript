...
```
Agent(
  prompt="Read C:/Kool/tnolva-javascript/nutikas/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/VALIDATION.md`
