...
```
Agent(
  prompt="Read C:/Kool/tnolva-javascript/nutikas/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/SECURITY.md`
