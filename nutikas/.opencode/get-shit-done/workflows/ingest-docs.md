...
```bash
INIT=$(node "C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
