...
<template>
@C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/workflows/transition.md`.
...
- Follow @C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/workflows/diagnose-issues.md
