...
Reference full template: `C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/state.md`.
