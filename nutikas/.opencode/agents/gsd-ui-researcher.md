...
Use template from `C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/templates/UI-SPEC.md`
