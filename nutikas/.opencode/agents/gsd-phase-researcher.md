...
@C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/Kool/tnolva-javascript/nutikas/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
