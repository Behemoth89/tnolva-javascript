...
<execution_context>
@C:/Kool/tnolva-javascript/react-todo/.opencode/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/Kool/tnolva-javascript/react-todo/.opencode/get-shit-done/workflows/session-report.md end-to-end.
</process>
