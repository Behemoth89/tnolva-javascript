...
**Domain:** React SPA with JWT authentication, Tailwind CSS, React Router, Docker deployment
...
```bash
# Core
npm install react@^19.2 react-dom@^19.2 react-router@^7.14 axios@^1.7 zustand@^5.0 @heroicons/react@^2.2

# Build & styling
npm install -D vite@^8.0 @vitejs/plugin-react@^6.0 typescript@^5.7 @types/react@^19.0 @types/react-dom@^19.0 tailwindcss@^4.2 @tailwindcss/vite@^4.2
```
...
**If building a pure SPA (this project):**
...
*Stack research for: React Todo App with JWT Authentication*
*Researched: 2026-04-03*
