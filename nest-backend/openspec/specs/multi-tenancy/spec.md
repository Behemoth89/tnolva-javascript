...
This specification defines the multi-tenancy requirements for the NestJS SaaS backend, including tenant isolation via companyId, BaseEntity structure, and support for future migration strategies.
