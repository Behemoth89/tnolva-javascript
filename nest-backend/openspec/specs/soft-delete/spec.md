...
This specification defines the soft delete requirements for the NestJS SaaS backend, including BaseEntity soft delete functionality, automatic query filtering, and restore capabilities.
