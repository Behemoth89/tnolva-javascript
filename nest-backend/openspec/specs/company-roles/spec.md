...
This specification defines the company roles and permissions hierarchy for the NestJS SaaS backend, including role capabilities for OWNER, ADMIN, and MEMBER roles.
