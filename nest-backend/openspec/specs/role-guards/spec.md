...
This specification defines the role-based access control guards for the NestJS SaaS backend, including OwnerGuard, AdminGuard, MemberGuard, and their integration with JWT and X-Company-Id header validation.
